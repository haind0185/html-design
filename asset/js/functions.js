...
**********************************************************************/
    ...
    $('[data-toggle="offcanvas"], .btn-offcanvas').on('click', function () { 
        ...
        if($('.row-offcanvas-left').hasClass('active'))
        {
            ...
            $(this).find('i').addClass('fa-bars-rotate');    
        }
        else
        {
            $(this).find('i').removeClass('fa-bars-rotate');
    ...
    if($(window).width()<1024){
        $("ul#main-menu-offcanvas li").click(function(){
           if($(this).hasClass("open")){
               $(this).removeClass("open")
               $(this).find("b").removeClass("arrow-up")
           }
           else{
               $(this).addClass("open") 
               $(this).find("b").addClass("arrow-up")
           }
       });
        $("ul#main-menu-offcanvas li .caret").click(function(){
           if($(this).hasClass("open")){
               $(this).removeClass("open");
